...
public class Specification {
	...
	public static final double TIRE_INNER_RADIUS = TIRE_RADIUS - 0.01;
	public static final double PAIR_OF_WHEELS_ROD_DEPTH = 0.2;
	public static final double PAIR_OF_WHEELS_ROD_RADIUS = 0.01;
	public static final int SLICES_IN_WHEEL = 25;
	public static final int STACKS_IN_WHEEL = 1;
	public static final int LOOPS_IN_WHEEL = STACKS_IN_WHEEL;


	// Front Body Specification:
	public static final double F_HOOD_TOTAL_LENGTH = 0.5;
	public static final double F_HOOD_LENGTH_2 = 2.5*TIRE_RADIUS;
	public static final double F_HOOD_LENGTH_1 = F_HOOD_TOTAL_LENGTH-F_HOOD_LENGTH_2;
	...
	public static final double F_BUMPER_DEPTH = 0.75*F_HOOD_DEPTH_1;
	...
	public static final double F_BUMPER_WINGS_HEIGHT = 0.5*F_HOOD_HEIGHT_1;
	public static final double F_FRONT_LENGTH = F_HOOD_TOTAL_LENGTH + F_BUMPER_LENGTH;
	
	// Center Body Specification:
	// --> Base
	public static final double C_BASE_LENGTH  = 0.25;
	public static final double C_BASE_HEIGHT= 0.1*F_HOOD_HEIGHT_1;
	public static final double C_BASE_DEPTH = F_HOOD_DEPTH_1;
	// --> Back Seat
	...
	// --> Side
	public static final double C_SIDE_LENGTH = (C_BASE_DEPTH-C_FRONT_DEPTH_1)/2.0;
