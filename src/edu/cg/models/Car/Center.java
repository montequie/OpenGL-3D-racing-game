...
public class Center implements IRenderable {
    ...
    private SkewedBox bodyBase = new SkewedBox(Specification.C_BASE_LENGTH, Specification.C_BASE_HEIGHT,
            Specification.C_BASE_HEIGHT, Specification.C_BASE_DEPTH, Specification.C_BASE_DEPTH);
    // backSeatBox is the back seat of the center.
    private SkewedBox backSeatBox = new SkewedBox(Specification.C_BACK_LENGTH, Specification.C_BACK_HEIGHT_1,
    ...
    public void render(GL2 gl) {
        ...
        gl.glTranslated((Specification.C_BASE_LENGTH - Specification.C_FRONT_LENGTH) / 2.0,
                Specification.C_BASE_HEIGHT, 0.0);
        frontBox.render(gl);
        gl.glPopMatrix();
        gl.glPushMatrix();
        gl.glTranslated((Specification.C_FRONT_LENGTH - Specification.C_BASE_LENGTH) / 2.0,
                Specification.C_BASE_HEIGHT, 0.0);
        ...
        gl.glPopMatrix();
        gl.glPushMatrix();
//        gl.glTranslated(0.0, Specification.C_BASE_HEIGHT, 0.125);
        gl.glTranslated(0.0, Specification.C_BASE_HEIGHT, Specification.C_BASE_LENGTH / 2);
...
//        gl.glTranslated(0.0, Specification.C_BASE_HEIGHT, -0.125);
        ...
        Materials.SetBlackMetalMaterial(gl);
        gl.glPushMatrix();
        gl.glTranslated(Specification.C_BACK_LENGTH - Specification.C_BASE_LENGTH / 2.0,
                Specification.C_BASE_HEIGHT, 0.0);
